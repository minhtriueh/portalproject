...
public class TaoTruong_Result {
    ...
    private long callService(String diachi,
        ...
        try {
            ...
            qlthongtinkhoitaocomapp.QLThongTinKhoiTaoComAppService1 serv = new qlthongtinkhoitaocomapp.QLThongTinKhoiTaoComAppService1();
            qlthongtinkhoitaocomapp.TaoTruongPortType port = serv.getTaoTruong();
